      ...
      <footer className={props.className}>
        <div className="flex flex-col md:gap-10 gap-[100px] items-center justify-center mb-8 mt-16 mx-auto w-[85%]">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
            ...
            <div className="flex md:flex-1 flex-col gap-[45px] items-start justify-start pr-1 py-1 w-[17%] md:w-full">
              <Text
                className="text-2xl md:text-[22px] text-white-A700 sm:text-xl"
                size="txtPoppinsBold24WhiteA700"
              >
            ...
            <div className="flex md:flex-1 flex-col gap-[39px] items-start justify-end pr-1 py-1 w-[17%] md:w-full">
              <Text
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start md:mt-0 mt-1 w-[24%] md:w-full">
              <Text
                className="text-2xl md:text-[22px] text-white-A700 sm:text-xl"
                size="txtPoppinsBold24WhiteA700"
              >
